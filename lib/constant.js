    ...
    geo: {
        ...
        DE: {
            ...
            product_information: {
                ...
                fields: {
                    'Amazon Bestseller-Rang': { key: '', rank: true },
                    'Bestseller-Rang': { key: '', rank: true }, // to verfiy
                    'Bestsellerrang': { key: '', rank: true }, // to verfiy
                    'Verpackungsabmessungen': { key: 'dimensions' }, // to verfiy
                    'Produktabmessungen': { key: 'dimensions' },
                    'Paketabmessungen': { key: 'dimensions' }, // to verfiy
                    'Artikelgewicht': { key: 'weight' },
                    'Hersteller': { key: 'manufacturer' },
                    'Erscheinungstermin': { key: 'available_from' },
                    'Im Angebot von Amazon.de seit': { key: 'available_from' },
                    'Modellnummer': { key: 'model_number' },
                    'Kategorie': { key: 'department' },
                },
            },
        },
        IN: {
